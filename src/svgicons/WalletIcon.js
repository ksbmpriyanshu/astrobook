...
function WalletIcon(props) {
  return (
    ...
    >
      <Path
        fill="url(#pattern0_251_1046)"
        d="M0.556641 0.63147H33.371141V33.44597H0.556641z"
      />
      <Defs>
        <Pattern
          id="pattern0_251_1046"
          patternContentUnits="objectBoundingBox"
          width={1}
          height={1}
        >
          <Use
            xlinkHref="#image0_251_1046"
            transform="translate(0 -.362) scale(.0125)"
          />
        </Pattern>
        <Image
          id="image0_251_1046"
