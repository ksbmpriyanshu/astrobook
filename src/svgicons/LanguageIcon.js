...
function LanguageIcon(props) {
  return (
    ...
    >
      <Path
        fill="url(#pattern0_251_1047)"
        d="M0.523926 0.63147H39.491126V33.44597H0.523926z"
      />
      <Defs>
        <Pattern
          id="pattern0_251_1047"
          patternContentUnits="objectBoundingBox"
          width={1}
          height={1}
        >
          <Use
            xlinkHref="#image0_251_1047"
            transform="matrix(.0099 0 0 .01124 -1.099 -.247)"
          />
        </Pattern>
        <Image
          id="image0_251_1047"
