...
export const base_url = "https://api.astroremedy.com/";
export const img_url = "https://api.astroremedy.com/uploads/";
export const api_url = "https://api.astroremedy.com/api/";
